...
class App extends Component {
  ...
  getUserEnteredText = event => this.setState({searchInput: event.target.value})

  onDelete = id => {
    const {historyList} = this.state
    const unDeletedList = historyList.filter(each => each.id !== id)
    this.setState({historyList: unDeletedList})
  }
...
https://assets.ccbp.in/frontend/react-js/search-img.png"
            ...
            <input
              value={searchInput}
              onChange={this.getUserEnteredText}
